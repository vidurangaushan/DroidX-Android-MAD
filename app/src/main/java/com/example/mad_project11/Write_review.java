...
public class Write_review extends AppCompatActivity {
    ...
    private TextView nameText,catText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameText = findViewById(R.id.tv_rname);
        catText = findViewById(R.id.tv_rname2);
        ...
        catText.setText("Category: " +category);
        ...
        button.setOnClickListener(view -> {
            ...
            if(TextUtils.isEmpty(etName.getText().toString()))
                Toast.makeText(getApplicationContext(), "Please enter Your service Provider name" , Toast.LENGTH_SHORT).show();
